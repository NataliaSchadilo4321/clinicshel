          ...
          <div class="form-group">
            ...
            <select name="likar" class="form-control" id="likar">
            	...
            	while ($row=mysqli_fetch_array($query)) {
            		?>
            		<option value="<?php echo $row['6'];?>"><?php echo $row['firstname'].' '.$row['lastname'].' /'.$row['speciality'].' /'.$row['number'].' /'.$row['cabinet_number'];?></option>
            	<?php	
       }
       ?>
            </select>
       ...
       ?>
          ...
          <div class="form-group">
           <input type="submit" class="btn btn-primary" value="Submit" name="Submit">
            ...
            <input type="hidden" name="admin_email" value="nataliaschadilo@gmail.com">
            <input type="hidden" name="form_subject" value="Form Sabject">
        </form>
      </div>
    </div>
  </div>
